...
public class ViewEquipmentForm extends JDialog {
	...
	private void addLabelsShow(JPanel panel) {
		...
		comboBox_MemoryRam.setForeground(COLOR2);
		...
		comboBox_HardDisk.setForeground(COLOR2);
		...
		comboBox_CostType.setForeground(COLOR2);
		...
		textField_Value.setForeground(COLOR2);
